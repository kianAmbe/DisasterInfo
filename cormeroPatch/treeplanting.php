...
<head>
    <meta charset="UTF-8">
    <title>Tree Planting Events</title>
    <style>
        /* CSS styles */
        body {
...
$sql = "SELECT id, host, description, datetime, participants FROM activities WHERE event_number = 20";
...
if ($result->num_rows > 0) {
    ...
    echo "<table>
            ...
            echo "No activities found with event_number = 20";
        }
...
?>
    ...
    <form method="post" action="process_activity.php">
        <input type="hidden" name="event_type" value="treeplanting"> <!-- Ensure this value is set -->
