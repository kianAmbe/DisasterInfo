...
<div class="container">
        ...
        <thead>
            ...
            <tbody>
            <?php
// PHP code to fetch and display activities from the database with event_number = 10
...
// Fetch activities from the activities_table where event_number = 10
$sql = "SELECT id, host, description, datetime, participants FROM activities WHERE event_number = 10";
...
if ($result->num_rows > 0) {
    ...
    echo "<table>
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                // Adding event_number as a hidden input field in the form
    ...
    echo "No activities found with event_number = 10";
}
...
?>
        ...
        <form method="post" action="process_activity.php">
                <input type="hidden" name="event_type" value="blood">
