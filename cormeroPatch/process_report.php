...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt) {
        ...
        if ($stmt->execute()) {
            ...
            echo '<script>';
            echo 'if (confirm("Report Submitted! Do you want to go home?")) { window.location.href = "index.php"; }';
            echo 'else { window.location.href = "report.php"; }'; // Redirect to report.php if 'Cancel' is clicked
            echo '</script>';
        } else {
