...
$sql = "SELECT id, host, description, datetime, participants FROM activities WHERE event_number = 60";
...
if ($result->num_rows > 0) {
    ...
    echo "<table>
            ...
            echo "No activities found with event_number = 60";
        }
...
?>
    ...
    <form method="post" action="process_activity.php">
        <input type="hidden" name="event_type" value="nature"> <!-- Ensure this value is set -->
